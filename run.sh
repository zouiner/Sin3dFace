#!/bin/bash
#SBATCH --job-name=Sin3d_vggface2_8_32_256_32_model2             # Job name
...
#SBATCH --output=cuda_log/Sin3d_vggface2_8_32_256_32_model2_%j.log      # Standard output and error log
...
torchrun --nproc_per_node=3 main_distill.py --cfg_path configs/Sin3d_vggface2_8_32_256_32.yaml --save_dir logs/Sin3d_vggface2_8_32_256_32_model2 --resume /users/ps1510/scratch/Programs/Sin3dFace/logs/Sin3d_vggface2_8_32_256_32_model2/2025-04-01-10-17/ckpts/model_55000.pth
...
# torchrun --nproc_per_node=3 main_distill.py --cfg_path configs/Sin3d_vggface2_8_32_256_32.yaml --save_dir logs/Sin3d_vggface2_8_32_256_32_001 --alpha 0.001 --resume /users/ps1510/scratch/Programs/Sin3dFace/logs/Sin3d_vggface2_8_32_256_32_001/2025-04-23-01-25/ckpts/model_106000.pth
