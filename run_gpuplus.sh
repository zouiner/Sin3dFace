#!/bin/bash
#SBATCH --job-name=SinSR_test_gpuplus             # Job name
...
#SBATCH --output=cuda_log/SinSR_test_gpuplus_%j.log      # Standard output and error log
#SBATCH --partition=gpuplus                        # Select the GPU nodes... (, interactive, gpu , gpuplus)  
#SBATCH --gres=gpu:2                          # ...and the Number of GPUs
...
# to run the command: sbatch run_gpuplus.sh