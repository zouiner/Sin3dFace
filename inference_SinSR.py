...
from sampler_SR import Sampler
...
# python3 -m debugpy --listen 0.0.0.0:5678 --wait-for-client inference_SinSR.py -i /users/ps1510/scratch/Programs/3d-super-resolution-Face-reconstruction/contents/NoW_MICA_8_64/sr_8_64 -o results/SinSR/LYHM --scale 4 --ckpt /users/ps1510/scratch/Programs/Sin3dFace/data/weights/SinSR_v2.pth --one_step